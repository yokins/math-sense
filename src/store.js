 ...
 * @LastEditTime: 2019-11-01 16:08:13
 */
import Vue from 'vue'
...
export default new Vuex.Store({
  ...
  actions: {
    ...
    /**
     * @description: 更新是否检查过版本
     * @param {type} 
     * @return: 
     */
    updatehadCheckVersion({commit}, payload) {
      commit(types.SET_STATE, { key: 'hadCheckUpdate', value: payload });
    }
  },
